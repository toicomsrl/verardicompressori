...
/* ====================================== */
  ...
  -------------------------------------*/
	...
	if ($("#clock").length > 0) {
		$("#clock").countdown("2024/10/10", function (event) {
			$(this).html(event.strftime("" + '<div class="conut-time"><span class="time_left">86</span><span class="time_description">Day%!d </span></div>' + '<div class="conut-time"><span class="time_left">05</span><span class="time_description"> Hours </span></div> ' + '<div class="conut-time"><span class="time_left">33</span><span class="time_description"> Minutes </span></div>' + '<div class="conut-time"><span class="time_left">%S</span><span class="time_description"> Seconds </span></div>'))
		})
	}
  ...
  -------------------------------------*/
	...
	$(".active-onhover .pbmit-static-box-style-1")
		.mouseover(function () {
  ...
  -------------------------------------*/
	...
	$(".main-menu ul.navigation li.dropdown>a").on("click", function () {
		if ($(this).attr("href") == "#") {
			$(this).siblings().toggleClass("open")
			$(this).find("i").toggleClass("pbmit-base-icon-angle-right pbmit-base-icon-up-open-big")
			return false
